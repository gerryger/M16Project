    ...
    <body>
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <div class="overlay-slide">
                            <img src="images/slider/subhaus-2.PNG" style="height: 100%;width: 100%"  alt="" class="img-responsive">
                        </div>
                        <div class="carousel-caption">
                            <div class="col-md-12 col-xs-12 text-center">
                                <img src="images/subhaus_logo.png" style="width: 300px;height: 300px;border: hidden" alt="..." />
                                <br/>
                    ...
                    <div class="item">
                        <div class="overlay-slide">
                            <img src="images/slider/subhaus-1.PNG" style="height: 100%;width: 100%"  alt="" class="img-responsive">
                        </div>
                        <div class="carousel-caption">
                            <div class="col-md-12 col-xs-12 text-center">
                                <img src="images/subhaus_logo.png" style="width: 300px;height: 300px;border: hidden" alt="..." />
                    ...
                    <div class="item">
                        <div class="overlay-slide">
                            <img src="images/steak.jpg" style="height: 100%;width: 100%" alt="" class="img-responsive">
                        </div>
                        <div class="carousel-caption">
                            <div class="col-md-12 col-xs-12 text-center">
                                <img src="images/subhaus_logo.png" style="width: 300px;height: 300px;border: hidden" alt="..." />
       ...
       <!-- ============ Our Bread  ============= -->
                    ...
                    <ul class="image_box_story2">
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="images/slider/subhaus-1.PNG" style="width: 500px;height: 300px;"  alt="...">
                                    <div class="carousel-caption">
                                        
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="images/slider/subhaus-2.PNG" style="width: 500px;height: 300px;" alt="...">
                                    <div class="carousel-caption">
                                        
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="images/slider3.JPG" style="width: 500px;height: 300px;" alt="...">
                                    <div class="carousel-caption">
        ...
        <footer class="sub_footer">
            <div class="container">
                <div class="col-md-4"><p class="sub-footer-text text-center">&copy; Restaurant 2016, Theme by <a href="#">Telematics Research Group</a></p></div>
                <div class="col-md-4"><p class="sub-footer-text text-center">Back to <a href="#slider_part">TOP</a></p>
                </div>
