...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
 ...
 <body data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <header  class="navbar-fixed-top main-nav navbar-inverse" role="banner">
    	<div class="container">
    		<!-- <div class="row"> -->
                 <div class="navbar-header ">
                     <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="images/our_services/m16_logo_navbar.png" alt="" />
                        </a>
                ...
                <!-- M16 District [START] -->
           	 	<div class="item active">
           	 		<div class="overlay-slide">
           	 			<img src="images/home/m16.jpg" alt="" class="img-responsive">
           	 		</div>
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                      <h2>M16 District</h2>
               	 			<h3 class="animated2"> <b>Welcome</b> to M16 District </h3>
               	 			<div class="line"></div>
                ...
                <!-- Monroe [START] -->
                    ...
                    <div class="overlay-slide">
           	 		...
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Monroe</h2>
               	 			<h3 class="animated3"> Welcome to <b>Monroe</b></h3>
               	 			<div class="line"></div>
                ...
                <!-- Pitstop [START] -->
                    ...
                    <div class="overlay-slide">
           	 		...
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Pitstop</h2>
               	 			<h3 class="animated3"> Welcome to <b>Pitstop</b></h3>
               	 			<div class="line"></div>
               	 			<p class="animated2"> way to success</p>
               	 		</div>
           	 		</div>
                ...
                <!-- Flux [START] -->
                    ...
                    <div class="overlay-slide">
           	 		...
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Flux</h2>
               	 			<h3 class="animated3"> Welcome to <b>flux</b></h3>
               	 			<div class="line"></div>
               	 			<p class="animated2"> way to success</p>
               	 		</div>
           	 		</div>
...
<!-- Portfolio works Start -->
    ...
    <!-- <div id="isotope-filter" class="skew3 text-center">
        ...
        <a data-filter=".subhaus"  href="#" class="">Subhaus</a>
        <a data-filter=".monroe" href="#"  class="">Monroe</a>
        <a data-filter=".pitstop"  href="#" class="">Pitstop</a>
        <a data-filter=".flux"  href="#" class="">Flux</a>
    </div> -->
    <!-- <div class="clearfix"></div>
   			<div class="text-center ">
              <ul class="portfolio-wrap" id="portfolio_items">
                    <!-- Picture for Subhaus [START] -->
                    <!--<li class="col-xs-12 col-sm-6 col-md-4 single-portfolio subhaus">
                        <figure>
                    ...
                    <!-- Picture for Subhaus [END] -->
                  
                    <!-- Picture for Monroe [START] -->
                    <!-- <li class="col-xs-12 col-sm-6 col-md-4 single-portfolio monroe">
                        <figure>
                    ...
                    <!-- Picture for Monroe [END] -->
                    
                    <!-- Picture for Pitstop[START] -->
                    <!-- <li class="col-xs-12 col-sm-6 col-md-4 single-portfolio pitstop">
                        <figure>
                            <img src="images/portfolio/p3.jpg" alt="" />
                            <figcaption>
                                <h5>Creative Zoe</h5>
                    ...
                    <!-- Picture for Pitstop[END] -->
                  
                    <!-- Picture for Flux[START] -->
                    <!-- <li class="col-xs-12 col-sm-6 col-md-4 single-portfolio flux">
                        <figure>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="footer_bottom">
                        <p class="text-block"> &copy; Copyright reserved to <span>Telematics Research Group </span></p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
